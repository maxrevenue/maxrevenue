...
// DECISION: EAT lease early-release uses `localHp > comboEatHpThreshold` only (SustainAdvisor band transcription) — not tick-over-tick HP increase (removed to avoid sub-threshold regen false releases).
