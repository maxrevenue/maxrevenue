...
# Run from your git clone (e.g. Desktop\RoatzBot-PK), as Administrator not required.
...
# Stale attach cache from launch.ps1 / attach-agent.ps1
...
Write-Host "  Exe:   $exe"
Write-Host "  Agent: $agent ($([math]::Round($agentInfo.Length/1KB)) KB, $($agentInfo.LastWriteTime))"
Write-Host ""
...
Write-Host "If you still see 'Swapper Hub', you attached an OLD agent — close Roat fully and Play again."
Write-Host ""
