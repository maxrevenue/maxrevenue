...
public final class AnimationDb {
    ...
    static {
        ...
        // Blue moon spear Frostweaver jab (melee follow-up after ice)
  ...
  /** Food eat or potion drink — punish window animations. */
    ...
    public static boolean isStrongDefAnim(int animId) {
        ...
        // Eclipse atlatl throw / magic special — must flip overhead the same tick.
        if (animId == 11057 || animId == 11060) return true;
        // Frostweaver free jab after ice — pray melee for that hit.
